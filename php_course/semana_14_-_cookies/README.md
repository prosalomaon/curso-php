...
## Visão Geral
Esta aula cobre Cookies em PHP. 

## Interação com o Projeto
**Projeto Atual:** Cofre de Arquivos Seguro
Vamos aplicar os conceitos aprendidos hoje para construir funcionalidades para o Cofre de Arquivos Seguro.
